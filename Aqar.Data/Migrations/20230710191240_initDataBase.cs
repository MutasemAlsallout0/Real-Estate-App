        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Address_Address_CityId",
                        column: x => x.CityId,
                        principalTable: "Address",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Address_Address_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ActiveSate = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PublicPages_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Preferences", x => new { x.UserId, x.EstateId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Preferences_Estates_EstateId",
                        column: x => x.EstateId,
                        principalTable: "Estates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Followings", x => new { x.UserId, x.PublicPageId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Followings_PublicPages_PublicPageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Followings_PublicPageId",
                table: "Followings",
                column: "PublicPageId");

            migrationBuilder.CreateIndex(
                name: "IX_Preferences_EstateId",
                table: "Preferences",
                column: "EstateId");

            migrationBuilder.CreateIndex(
                name: "IX_PublicPages_UserId",
                table: "PublicPages",
                column: "UserId");
        }
